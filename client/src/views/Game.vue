<template>
  <div class="container">
    <h1 class="title is-5">Game Page</h1>
        ...
        <div class>
          <ul class="panel">
            ...
            <li v-for="player in Game.State.Players" :key="player.Name" class="panel-block">
              ...
              <span class="is-expanded flex-name">{{player.Name}}</span>
      ...
      <div class="column is-one-third">
        <div class>
          <ul class="panel">
            ...
            <li v-for="card in Game.MyCards" :key="card" class="panel-block">{{card}}</li>
          </ul>
        </div>
      </div>
      <div class="column">
        <div class>
          <ul class="panel">
            ...
            <li
              v-for="card in Game.State.CardsInPlay"
              :key="card.Text"
              class="panel-block"
            >>{{card.Text}}, {{card.PlayerId}}, {{card.IsChosen}}</li>
          </ul>
        </div>
      </div>
    </div>
